// Backup do antigo /newsletter (signup + lista de edições) — substituído pelo
// layout Synecdoche em 2026-04-28. Mantido aqui apenas como referência.
// Pasta `_legacy` é ignorada pelo App Router (prefixo "_").
...
export default function NewsletterPageLegacy() {
