...
export default function NotCryptoWalletTrackerPage() {
  return (
      ...
      <div className="max-w-4xl w-full">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-foreground mb-3 sm:mb-4 leading-tight break-words">
            Not Crypto Wallet Tracker
          </h1>
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Ferramenta de rastreamento de carteiras cripto para análise de mercado
          </p>
        </motion.div>
          ...
          <Card className="bg-background border-border">
            ...
            <CardContent className="space-y-4">
              <p className="text-foreground/80 leading-relaxed">
                Desenvolvi uma ferramenta de rastreamento de carteiras cripto que permite monitorar 
                movimentos de grandes investidores e analisar tendências do mercado em tempo real.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                A aplicação oferece insights valiosos para estratégias de investimento, 
                identificando padrões de movimentação e oportunidades de mercado.
              </p>
            </CardContent>
          </Card>
        </motion.div>
          ...
          <Card className="bg-background border-border">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {["Blockchain", "React", "TypeScript", "API Integration", "Analytics", "Real-time Data", "Chart.js", "Web3"].map((tech) => (
                  <span
                    key={tech}
