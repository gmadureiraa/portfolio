      ...
      <div className="max-w-4xl w-full">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Plataforma de conteúdo e estratégias para o mercado DeFi
          </p>
        </motion.div>
          ...
          <Card className="bg-background border-border">
            ...
            <CardContent className="space-y-4">
              <p className="text-foreground/80 leading-relaxed">
                O Defiverso é uma plataforma especializada em conteúdo e estratégias para o mercado DeFi. 
                Desenvolvi estratégias de marketing e copywriting especializado para educar e engajar 
                a comunidade DeFi brasileira.
              </p>
              <p className="text-foreground/80 leading-relaxed">
                Foco em criar conteúdo educativo, análises de protocolos DeFi e estratégias de 
                investimento para o mercado descentralizado.
              </p>
            </CardContent>
          </Card>
        </motion.div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h3 className="text-lg font-semibold text-foreground">Conteúdo Educativo</h3>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Guias de protocolos DeFi</li>
                    <li>• Análises de yield farming</li>
                    <li>• Tutoriais de liquidez</li>
                ...
                <div className="space-y-3">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>• Copywriting especializado</li>
                    <li>• SEO para DeFi</li>
                  </ul>
                </div>
              </div>
          ...
          <Card className="bg-background border-border">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {["DeFi", "Copywriting", "Marketing Digital", "Content Strategy", "Social Media", "SEO", "Analytics"].map((tech) => (
                  <span
                    key={tech}
