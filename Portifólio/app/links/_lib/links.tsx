...
export const links: LinkItem[] = [
  ...
  {
    id: "ia-kaleidos",
    title: "IA pra empresa (Kaleidos)",
    description: "Recupere até 70% do tempo da operação com IA",
...
export const socials: SocialItem[] = [
  {
    id: "twitter",
    url: "https://x.com/ogmadureira",
    icon: XIcon,
    label: "Twitter / X",
  },
  {
    id: "linkedin",
    url: "https://linkedin.com/in/madureira",
    icon: LinkedInIcon,
    label: "LinkedIn",
  },
  {
    id: "instagram",
    url: "https://instagram.com/ogmadureira",
    icon: InstagramIcon,
    label: "Instagram",
  },
  {
    id: "github",
    url: "https://github.com/gmadureiraa",
    icon: GitHubIcon,
    label: "GitHub",
  },
];
